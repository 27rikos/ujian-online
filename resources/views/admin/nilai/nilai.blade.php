                    ...
                    <table id="example" class="table table-hover table-bordered nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url("show-nilai/{$id}/edit/{$item->id}") }}" class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="{{ url("show-nilai/{$id}/delete/{$item->id }") }}" class="btn btn-danger btn-sm" ><i class="fa-solid fa-delete-left"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
